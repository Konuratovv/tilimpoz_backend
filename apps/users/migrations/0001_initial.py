    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(db_index=True, max_length=254, unique=True, verbose_name='Почтасы')),
                ...
                ('code', models.CharField(blank=True, max_length=9, null=True, verbose_name='Почтаны аныктоо учун убактылуу коду')),
